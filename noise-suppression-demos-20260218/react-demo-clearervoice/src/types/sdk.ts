...
export interface MinimalSdk {
  ...
  updateDefaultMediaSettings: (settings: { micAutoGainControl?: boolean; micEchoCancellation?: boolean; micNoiseSuppression?: boolean; updateActiveSessions?: boolean }) => Promise<void>;
